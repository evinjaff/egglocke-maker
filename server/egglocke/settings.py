"""
Django settings for egglocke project.
...
SECRET_KEY = 'django-insecure-*jj%!hrihqu#16ty75zqz^ue+$q=gbh2za#_tu)if9*!j5!7lz'
...
WSGI_APPLICATION = 'egglocke.wsgi.application'
